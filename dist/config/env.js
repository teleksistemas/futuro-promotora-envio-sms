...
const envSchema = zod_1.z.object({
    ...
    AUTH_KEY_51981091766: zod_1.z.string().min(1),
    AUTH_KEY_51981095827: zod_1.z.string().min(1),
    AUTH_KEY_51981028528: zod_1.z.string().min(1),
...
const { PORT, MSGING_URL, AUTH_KEY_SMS, AUTH_KEY_51981091766, AUTH_KEY_51981095827, AUTH_KEY_51981028528, MSGING_COMMANDS_URL, REQUEST_TIMEOUT_MS, API_TOKEN } = parsed.data;
exports.env = {
    port: Number(PORT),
